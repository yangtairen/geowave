<p align="center">
	<a href="http://ngageoint.github.io/geowave/"><img float="center" src="https://raw.githubusercontent.com/ngageoint/geowave/master/docs/content/userguide/images/geowave-full-logo-300px.png" alt="GeoWave"><br/><br/>
</p>
...
|:---------:|:--------:|:--------:|:------:|:----:|:------:|:----:|
| 2.10.x | 16.x | 1.6.x, 1.7.x | 2.x | 0.8.7 |  master (pull request pending) | Java8 |
