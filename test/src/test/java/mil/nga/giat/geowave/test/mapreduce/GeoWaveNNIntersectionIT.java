...
import mil.nga.giat.geowave.analytic.mapreduce.nn.NNIntersectionSuiteRunner;
...
public class GeoWaveNNIntersectionIT
{
	...
	@Test
	public void testNNIntersection()
			throws Exception {
		TestUtils.deleteAll(dataStorePluginOptions);
		dataGenerator.setIncludePolygons(true);
	...
	private void runNN(
		...
		final NNIntersectionSuiteRunner jobRunner = new NNIntersectionSuiteRunner();
